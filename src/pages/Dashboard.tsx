      ...
      <div className="container mx-auto px-6 py-8 relative z-10">
        ...
        >
          <div className="flex items-center gap-4">
            <Link to="/">
              <Button variant="ghost" size="sm" className="hover:scale-105 transition-spring">
        ...
        {!isConnected ? (
          ...
          >
            <div className="glass-card max-w-lg mx-auto p-12 rounded-2xl">
              <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-primary p-5 mb-6">
          ...
          <>
            ...
            >
              {quickStats.map((stat, index) => {
                ...
                return (
                  <Card key={index} className="glass-card hover:shadow-lg transition-spring">
